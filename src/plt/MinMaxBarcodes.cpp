...
const char *programInfo =
    "This is HistigramsOfBarcodesLength program which is a part of Peristence "
    "Landscape Toolbox by Pawel Dlotko. It takes as input the name of a file "
    "with a barcoes. It outputs min and max range of involved intervals.";
