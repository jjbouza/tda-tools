...
const char *programInfo = "This is PlotsOfDiagram program which is a part of "
                          "Peristence Landscape Toolbox by Pawel Dlotko. It "
                          "takes as input the name of a file with barcode.";
