...
int main(int argc, char **argv) {
  ...
  if (argc != 5) {
    ...
    std::cout
        ...
        << std::endl;
    std::cout
        << "Name of file with landscapes or barcodes from the second population"
        << std::endl;
  ...
  std::vector<PersistenceLandscape> landscapesSecondFamilly =
      createLandscapesFromTheFiles(namesOfFilesSecondFamilly);
  ...
  tStudentTest<PersistenceLandscape> k(landscapesFirstFamilly,
                                       landscapesSecondFamilly, functionToUse);
